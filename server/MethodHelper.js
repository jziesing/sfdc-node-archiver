            ...
            currclient.query(qrystr, (err, resp) => {
                if(err) {
					...
					for (let key in archdCase) {
						if(key != 'id' && key != 'record_type' && key != 'active_case' && archdCase[key] != 'null' && archdCase[key] != null && key != 'createddate' && key != 'systemmodstamp' && key != 'lastmodifieddate') {
					...
					for (let key in archdCase) {
	  					console.log(`${key}: ${archdCase[key]}`);
						if(key != 'id' && key != 'record_type' && key != 'active_case' && archdCase[key] != 'null' && archdCase[key] != null && key != 'createddate' && key != 'systemmodstamp' && key != 'lastmodifieddate' && key != 'lastmodifieddate') {
